...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('slam', default_value='false',
                          choices=['true', 'false'], description='Start SLAM.'),
    DeclareLaunchArgument('nav2', default_value='false',
                          choices=['true', 'false'], description='Start Nav2.'),
    DeclareLaunchArgument('world', default_value='warehouse',
                          description='Simulation World'),
    DeclareLaunchArgument('map', default_value='/opt/ros/jazzy/share/turtlebot4_navigation/maps/warehouse.yaml',
                          description='Full path to localization map yaml file.'),
